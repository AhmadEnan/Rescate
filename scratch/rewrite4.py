                      ...
                      children: [
                        ...
                        if (p < 1.0)
                          Align(
                            ...
                            child: Transform.translate(
                              offset: Offset(panelH * 0.45, 0), // Push halfway out the right side
                              child: Opacity(
                                opacity: (1.0 - p).clamp(0.0, 1.0),
                                child: Icon(
                                  LucideIcons.globe,
                                  size: panelH * 0.9,
                                  color: _OnboardingColors.textBrown.withOpacity(0.2), // Watermark style
                                ),
                              ),
                            ),
                          ),
                        ...
                        if (p > 0.0 && p < 2.0)
                          Align(
                            alignment: Alignment.centerLeft,
                            child: Transform.translate(
                              offset: Offset(-panelH * 0.45, 0), // Push halfway out the left side
                              child: Opacity(
                                opacity: (1.0 - (p - 1.0).abs()).clamp(0.0, 1.0),
                                child: Icon(
                                  LucideIcons.wifiOff,
                                  size: panelH * 0.9,
                                  color: _OnboardingColors.background.withOpacity(0.25),
                                ),
                              ),
                            ),
                          ),
                        ...
                        if (p > 1.0)
                          Align(
                            alignment: Alignment.bottomCenter,
                            child: Transform.translate(
                              offset: Offset(0, panelH * 0.45), // Push halfway down out the bottom
                              child: Opacity(
